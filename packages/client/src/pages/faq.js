...
const Accordion = ({ title, children }) => {
  ...
  return (
    <div className="collapse-area">
      ...
      {expand && <div className="collapse-content content">{children}</div>}
    </div>
  );
};
    ...
    <div>
      ...
      <main className="layout layout__small layout-grid layout-grid__sm">
        ...
        <section className="layout-grid layout-grid__sm collapse">
          <Accordion title="Do I need a microphone for Karaoke Nite?">
            <p>
          ...
          <Accordion title="How do I connect my microphone to the PC?">
          ...
          <Accordion title="How do I hear myself through the speakers?">
            <p>Windows users:</p>
            <ol className="list">
          ...
          <Accordion title="What are the new updates?">
